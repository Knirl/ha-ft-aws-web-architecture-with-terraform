...
A Terraform reimplementation of [Project 1: Highly Available, Fault-Tolerant AWS Web Architecture](../project1-repo-link) — same infrastructure, same design goals, this time provisioned entirely as code instead of built manually through the AWS Console.
